        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Learn computer science from industry experts. Master programming, 
              algorithms, and cutting-edge technologies with our comprehensive courses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/courses" className="text-base text-gray-300 hover:text-white transition-colors">
                  All Courses
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3">
                ...
                <span className="text-base text-gray-300">info@coursehub.com</span>
              </li>
              <li className="flex items-center space-x-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-base text-gray-300">San Francisco, CA</span>
              </li>
            </ul>
          </div>
        </div>
